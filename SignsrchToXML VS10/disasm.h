...
typedef struct t_cmddata {
  ...
  uchar          *name;                // Symbolic name for this command
} t_cmddata;
...
// their properties.
extern const uchar     *regname[3][9];
extern const uchar     *segname[8];
extern const uchar     *sizename[11];
extern const t_addrdec addr16[8];
extern const t_addrdec addr32[8];
extern const uchar     *fpuname[9];
extern const uchar     *mmxname[9];
extern const uchar     *crname[9];
extern const uchar     *drname[9];
extern const uchar     *condition[16];
...
typedef struct t_disasm {              // Results of disassembling
  ...
  uchar          dump[TEXTLEN];        // Hexadecimal dump of the command
  uchar          result[TEXTLEN];      // Disassembled command
  uchar          comment[TEXTLEN];     // Brief comment
